...
def scrape_all_beta(session, out='data/plsbeta_all.json'):
    os.makedirs('data', exist_ok=True)
    results = []
    for section in ['cases', 'statutes', 'rules', 'orders', 'notifications']:
        url = f"{BASE_URL}/beta/{section}"
        while url:
    ...
    print(f"[+] Saved {len(results)} all-beta records to {out}")
